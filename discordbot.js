...
const helpFields = [
  {
    ...
    commands: [
      ...
      ['login', [], 'login link (DM)'],
      ['play', [], 'link to a multiplayer room'],
            ...
            if (!message.author.bot) {
                ...
                if (message.channel.type === 'text') {
                        ...
                        const tokenId = parseInt(split[2]);
                          ...
                          const _renderMessage = ({
                            ...
                            return new Discord.MessageEmbed()
                              ...
                              // .setURL(`https://webaverse.com/creators/${address}`)
                              .setAuthor(userName, avatarPreview, `https://webaverse.com/creators/${address}`)
                              // .setDescription(description || 'This person is a noob without a description.')
                              // .setThumbnail(avatarPreview)
                              // .addField('Inline field title', 'Some value here', true)
                              // .setImage(avatarPreview)
                    ...
                    //       }
                        ...
                        await message.channel.send(`Play: https://app.webaverse.com/?room=${message.channel.id}`);
