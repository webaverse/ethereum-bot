...
/* Command: ${s.replace(/^\s*\S+\s*/, '')} */`, `/* Command:`);
                          ...
                          _openAiCodex(message, `\    
<|endoftext|>/* Hi folks! I am a professional shader developer; I have been writing GLSL code in shadertoy for over 10 years now. I have an hour of free time so I will gladly write any shader if you post your requests in a comment! I alwaut run this code on https://shadertoy.com/ to make sure it just works when you paste it in! */
